...
export default function Navbar() {
  ...
  const scrollToSection = (event, sectionId) => {
    ...
    // viewport center minus half of element height
  ...
  return (
    <>
      <div className="relative">
        <div
          className={`flex items-center justify-between px-2 lg:px-16 xl:px-28 py-5 lg:py-7 border-b z-50 ${
            Sticky && Large
              ? "fixed top-0 left-0 right-0 fade-in-top bg-white"
              : ""
          }`}
        >
          ...
          <nav className="hidden lg:flex ">
            ...
            <ul
              className={`flex items-center justify-center gap-9 font-bold text-base`}
            >
              <li
              ...
              <li
                onClick={(event) => scrollToSection(event, "aboutus")}
                className="hover:text-[#0d6efd] transition-all duration-300 cursor-pointer shadow-black uppercase text-lg"
              >
                About Us
              </li>
              <li
                onClick={(event) => scrollToSection(event, "service")}
                className="hover:text-[#0d6efd] transition-all duration-300 cursor-pointer shadow-black uppercase text-lg"
              >
                Service
              </li>
            ...
            <div className="flex items-center gap-16 lg:gap-20">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p>bibrowsolutionpvtlimited@gmail.com</p>
                </div>
              </div>
              <Button
                onClick={(event) =>
                  // navigate to bootom of website
                  scrollToSection(event, "contactus")
                }
                text="Contact Us"
                className="text-white text-base font-bold px-7  py-4 bg-[#104CBA] hover:bg-black cursor-pointer rounded-lg transition-all duration-500 break-keep"
              />
            </div>
          </div>
          <div
            className="lg:hidden text-xl px-4 py-4 mx-10 bg-gray-100 hover:bg-[#283641] hover:text-white rounded-lg"
        ...
        {HamBurger && (
          ...
          >
            <div
              className={`fixed  max-w-xs w-5/6 md:w-2/5 top-0 bg-white lg:hidden ${
                isClosing ? "fade-out-left" : "fade-in-left"
              } border-r-4 border-[#104CBA] h-screen z-50`}
            >
              <nav className="">
                ...
                <div
                  className="absolute -right-5 top-6 text-white px-2 py-2 rounded-full bg-[#283641] "
                  onClick={handleToggle}
                >
                  <IoMdClose size={20} />
                </div>
