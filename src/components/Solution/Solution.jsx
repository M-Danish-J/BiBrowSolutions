    ...
    return (
        <div className="relative">
            ...
            <div style={backgroundStyle} className=' flex flex-col xl:flex-row xl:items-center justify-evenly px-4 xl:px-40 xl:pt-72 xl:pb-40'>
                <div className="pt-20 xl:w-1/2" data-aos="fade-right" data-aos-offset="50" data-aos-easing="ease-in-sine">
                ...
                <div className="xl:w-1/2 mt-10 md:mt-0 flex justify-end" data-aos="fade-left" data-aos-offset="50" data-aos-easing="ease-in-sine">
